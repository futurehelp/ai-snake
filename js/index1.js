...
function main(ctime) {
    ...
    // console.log(ctime)
    if((ctime - lastPaintTime)/1000 < 6/speed){
        return;
    }
    lastPaintTime = ctime;
    gameEngine();
...
// More API functions here:
    ...
    async function predict() {
        ...
        for (let i = 0; i < maxPredictions; i++) {
            ...
            const classPredict = prediction[i].className;
            const probability = prediction[i].probability.toFixed(2);

            if (probability == 1.00) {
                
                if (classPredict === "right") {
                    console.log("ArrowRight");
                    inputDir.x = 1;
                    inputDir.y = 0;
                    break;
                } else if (classPredict === "left") {
                    console.log("ArrowLeft");
                    inputDir.x = -1;
                    inputDir.y = 0;
                    break;
                }else if (classPredict === "down") {              
                    console.log("ArrowDown");
                    inputDir.x = 0;
                    inputDir.y = 1;
                }else if (classPredict === "up") {              
                    console.log("Arrowup");
                    inputDir.x = 0;
                    inputDir.y = -1;
                }
